...
with open(election_analysis, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_percentage = int(voter_turnout) / int(total_votes) * 100
        ...
        if (voter_turnout > county_voter_turnout) and (county_percentage > voter_percentage):
            county_voter_turnout = voter_turnout
            voter_percentage = county_percentage
